...
/// [ExpansionStepperCard] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class ExpansionStepperCard extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionStepperCard({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  /// Stepper [List] of type [StepperChildren] to render the Stepper on the UI with data
  final List<StepperChildren> stepperChildren;
  ...
  ///
  /// Note : When using the [iconWidget] from [StepperChildren] to pass
  ...
  /// The padding around the outside of the ExpansionStepperCard while collapsed.
  ///
  ...
  @override
  ExpansionStepperCardState createState() => ExpansionStepperCardState();
}

class ExpansionStepperCardState extends State<ExpansionStepperCard>
  ...
  Widget _getPreferredStepper(BuildContext context, {required int index}) {
    if (widget.stepperDirection == Axis.horizontal) {
      return HorizontalStepperItem(
        index: index,
        item: widget.stepperChildren[index],
        totalLength: widget.stepperChildren.length,
        activeIndex: widget.activeIndex,
        isInverted: widget.inverted,
        inActiveBarColor: widget.inActiveBarColor,
      ...
      return VerticalStepperItem(
        ...
        item: widget.stepperChildren[index],
        totalLength: widget.stepperChildren.length,
        gap: widget.verticalGap,
        activeIndex: widget.activeIndex,
        isInverted: widget.inverted,
        inActiveBarColor: widget.inActiveBarColor,
        activeBarColor: widget.activeBarColor,
        barWidth: widget.barThickness,
        iconHeight: widget.iconHeight,
        iconWidth: widget.iconWidth,
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    var crossAxisAlign = widget.stepperDirection == Axis.horizontal
    ...
    final Iterable<int> iterable = Iterable<int>.generate(widget.stepperChildren.length);
    return AnimatedBuilder(
      animation: _controller.view,
      builder: _buildChildren,
      child: closed ? null : Column(
        children: [
          Column(children:  iterable
